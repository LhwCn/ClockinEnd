...
public class JedisUtils {
    ...
    public static final String KEY_PREFIX = "mobilesys";//前缀

    public static final int REDIS_CACH_SECOND = 24 * 60 * 60;//缓存时间   24h

    public static final int REDIS_CACH_48H = 48 * 60 * 60;//缓存时间   48h

    public static final int REDIS_CACH_3H = 3 * 60 * 60;//缓存时间   3h

    public static final int REDIS_CACH_SECOND_SHORT = 2 * 60 * 60;//缓存时间   2h

    public static final int REDIS_CACH_SECOND_LOGIN_Min = 15 * 60;//缓存时间   15min

    public static final int REDIS_CACH_SECOND_PCQRCODE = 2 * 60;//缓存时间   120S

    public static final int REDIS_CACH_SECOND_PCQRCODE_Min = 30;//缓存时间   30S

    public static final int REDIS_CACH_SECOND_PCQRCODE_Ten = 60;//缓存时间   60S
