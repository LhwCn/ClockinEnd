...
import com.itlozg.admin.mapper.SignRangeMapper;
...
import com.itlozg.admin.service.ISignRangeService;
...
@Service
@Transactional
public class SignRangeServiceImpl extends BaseServiceImpl<SignRangeMapper, SignRange> implements ISignRangeService {
    ...
    * */
    ...
    public SignLonLatInfoResponse findFenceByRuleIdGroupBy(String ruleId) {
        ...
        //获取到对应规则的经纬度集合
        SignRule asd = iSignRuleService.getById(ruleId);
        String rangeId = iSignRuleService.getById(ruleId).getRangeId();
        List<SignLongitudeLatitude> signLongitudeLatitudes = baseMapper.findFenceByRuleId(rangeId);
        //获取经纬度集合的第一个结果的组id
